		...
		<div class="text-right">
			...
			enctype="multipart/form-data">
				...
				<div class="form-group row">
					...
					<div class="col-sm-5">
						<textarea type="text" name="description" cols="50" rows="2" class="form-control">
						</textarea>
					</div>
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
					...
					<div class="col-sm-3">
						<input type="text" name="caetgory" class="form-control">
					</div>
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
					<label class="col-md-2"><fmt:message key="productImage" /></label>
					<div class="col-sm-5">
